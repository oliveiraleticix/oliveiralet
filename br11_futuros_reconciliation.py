...
SAP_CANDIDATES = {
    "posting_date": (
        "movement__posting_date",
        "movement__entry_date",
        "posting_date",
        "document_date",
        "date",
        "movement__erp_created_at",
    ),
    "posting_ts": (
        "movement__posting_ts",
        "movement__updated_at",
        "movementsUpdatedAtNormalized",
        "movement__erp_created_at",
        "posting_ts",
        "updated_at",
        "ingestion_ts",
    ...
    "canu": (
        "movement__canu",
        "movement__cost_center",
        "movement__profit_center",
        "movement__erp_cost_center_name",
        "canu",
        "cost_center",
        "profit_center",
    ),
    "debit_credit": (
        "movement__debit_credit",
        "MovementType",
        "movement_type",
        "debit_credit",
        "dc_indicator",
